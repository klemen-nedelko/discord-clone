...
export const MembersModal = ()=>{
    ...
    const members = server?.memebers?.length;
    const membersString = members > 1 ? "Members" : "Member";
        ...
        <Dialog open={isModalOpen} onOpenChange={onClose}>
            <DialogContent className="bg-white text-black overflow-hidden">
                <DialogHeader className="pt-8 px-6">
                    <DialogTitle className="text-2xl text-center font-bold">Menage Members</DialogTitle>
                    <DialogDescription
                ...
                >
                    {server?.memebers?.map((member) =>(
                        <div key={member.id}
                            className='flex itemx-center gap-x-2 mb-6'
                        >
                            <UserAvatar
