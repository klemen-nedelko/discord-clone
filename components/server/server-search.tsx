...
import { CommandEmpty, CommandGroup, CommandInput, CommandList } from "cmdk";
  ...
  const onClick = ({id, type}:{id:string, type:"channel" | "member"}) =>{
    ...
    return (
      <>
        ...
        className="group px-2 py-2 roundede-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition"
        >
